...
ACCOUNT_SIGNUP_FIELDS = ['email*', 'username*', 'password1'] # CORRIGIDO: usa 'password1' e adiciona '*' para campos obrigatórios
...
MAILCHIMP_DATA_CENTER = os.environ.get('MAILCHIMP_DATA_CENTER') # Ex: us19